...
use S1ct\Api\Customizer\Sidebar;
use S1ct\Api\Customizer\Header;
use S1ct\Api\Customizer\Footer;
...
class Customizer 
{
	...
	public function output()
	{
		echo '<!--Customizer CSS--> <style type="text/css">';
			echo self::css( '#sidebar', 'background-color', 's1ct_sidebar_background_color' );
			echo self::css( '.site-footer', 'background-color', 's1ct_footer_background_color' );
			echo self::css( '.site-header', 'background-color', 's1ct_header_background_color' );
			echo self::css( '.site-header', 'color', 's1ct_header_text_color' );
			echo self::css( '.site-header a', 'color', 's1ct_header_link_color' );
